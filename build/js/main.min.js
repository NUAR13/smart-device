...
var modalCon = document.querySelector('.modal__content');
...
var closeModalEsc = function closeModalEsc(keydownEvt) {
...
var allElems = document.querySelectorAll('.page-footer .page-footer__button-wrapper');
var allButton = document.querySelectorAll('.page-footer .open-accordion');
var closeNoJs = document.querySelectorAll('.page-footer__accordeon-item');
closeNoJs.forEach(function (element) {
  element.classList.remove('no-js');
});
allElems.forEach(function (elem) {
  elem.addEventListener('click', function (evt) {
    /*находим все активные элементы*/
    var descActive = document.querySelectorAll('.page-footer .page-footer__accordeon-list.page-footer__accordeon-show');
    /*прогоняем через цикл и удаляем класс active*/
    descActive.forEach(function (elem) {
    ...
    var contentBlock = parentElem.querySelector('.page-footer__accordeon-list');
